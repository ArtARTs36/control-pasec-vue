...
window.API_SUPPLY_STATUS_RULES_INDEX = window.API_URL + '/supply-status-rules/';
...
window.USER_NOTIFICATION_DOCUMENT_OF_QUEUE_GENERATED = 'document_of_queue_generated';
